    ...
    return(
        <div className="w-full h-32 bg-transparent flex flex-row justify-between">
            <div className="w-1/3 h-full">
                <Image src={"/Images/Logo.png"} alt="Image Not found" width={250} height={250}/>
            </div>
            <div className="w-1/3 h-full">
            ...
            <div className="w-1/3 h-full flex flex-row justify-end">
                <button className="w-36 h-16 bg-white rounded-4xl text-black">
                    Contact Us!
                </button>
            </div>
        </div>
